...
- every merged bloom carries the deterministic set of ancestry colors; a tree spanning all six is celebrated as a rainbow tree without creating collection or progression state;
