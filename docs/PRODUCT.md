...
**Principle (owner-set 2026-08-24):** each world defines a bounded minimum and maximum experience and its own meaningful signals of interaction fluency. The world gradually and reversibly adapts within that envelope based on recent play, without visible scores, failure states, levels, or abrupt difficulty jumps. Adaptation enriches or simplifies the experience rather than rewarding or punishing the child. Companion rule: measure the interaction the game actually cares about — never invent generic performance metrics merely because they are easy to count.
